            ...
            <div class="mbr-table">
                ...
                <div class="mbr-table-cell">
                    ...
                    <ul class="nav-dropdown collapse pull-xs-right nav navbar-nav navbar-toggleable-sm" id="exCollapsingNavbar">
                     ...
                     <li class="nav-item"><a class="nav-link link" href="#features1-5">ITINERARY</a></li>
                     <li class="nav-item"><a class="nav-link link" href="#gallery4-6">GALLERY</a></li>
                     <li class="nav-item"><a class="nav-link link" href="#map1-4">LIVE TRACKING</a></li>
                     <li class="nav-item"><a class="nav-link link" href="#social">SOCIAL</a></li>
                     <li class="nav-item"><a class="nav-link link" href="#testimonials3-i">TESTIMONIALS</a></li>
                     <li class="nav-item nav-btn"><a class="nav-link btn btn-primary-outline btn-primary" href="https://mobirise.com/">DOWNLOAD CERTIFICATE</a></li></ul>
...
<section class="engine"><a rel="external" href="https://mobirise.com">simple mobile web building</a></section><section class="mbr-section mbr-parallax-background mbr-after-navbar" id="msg-box8-2" style="background-image: url(assets/images/desert.jpg); padding-top: 160px; padding-bottom: 40px;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-xs-center">
                <h3 class="mbr-section-title display-2">TRIP TO SHIMLA</h3>
                <div class="lead"><p>MSSW - Department of Computer Science and Engineering&nbsp;</p></div>
            ...
            <div class="container">
                <div class="card cart-block">
                    ...
                    <div class="card-block">
                        ...
                        <h5 class="card-subtitle">Google has a highly exhaustiv<span style="font-style: normal;">e</span> list of fonts</h5>
        ...
        <div class="mbr-cards-col col-xs-12 col-lg-2" style="padding-top: 80px; padding-bottom: 80px;">
            <div class="container">
                <div class="card cart-block">
                    ...
                    <div class="card-block">
                        <h4 class="card-title">Day 3<br><span style="color: rgb(91, 91, 91); font-family: Lora, serif; font-size: 0.875rem; font-style: italic; font-weight: 400; line-height: 1.7857;">Mobirise gives you the freedom to develop</span><br></h4>
...
<section class="mbr-section mbr-section-nopadding" id="map1-4" style="height: 600px; width: 50%">
    <div class="mbr-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&amp;q=place_id:ChIJZ25d4-N4BTkRt1Sf__Z_fh8" allowfullscreen=""></iframe></div>
</section>
    ...
    <div class="row">
            ...
            <div class="col-xs-12 col-md-6 col-lg-3" data-form-type="formoid">
                ...
                <form action="https://mobirise.com/" method="post" data-form-title="MESSAGE">
                    ...
                    <input type="hidden" value="P3JN+8L+cEhk16sNqQIizZbkjqYfY+7lpQnLpWoM1lU8Dg/gFRtLOkj4l+Nt7agfc9DHGIyjDnLvvJygZ5JbFZ4YI7mHLQf/nRfrZuM7+89+U7nRvmGWOKf/y+OswGbt" data-form-email="true">

                    

                    <div class="form-group">
                        <label class="form-control-label" for="contacts3-6-email">Email<span class="form-asterisk">*</span></label>
                        <input type="email" class="form-control input-sm input-inverse" name="email" required="" data-form-field="Email" id="contacts3-6-email">
                    </div>

                    

                    <div class="form-group">
                        <label class="form-control-label" for="contacts3-6-message">Message</label>
                        <textarea class="form-control input-sm input-inverse" name="message" data-form-field="Message" rows="5" id="contacts3-6-message"></textarea>
                    </div>
